      ...
      <section className="pt-32 pb-16 px-6 bg-gradient-to-b from-trima-50 to-white relative overflow-hidden">
        ...
        <div className="container max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h1 className="text-5xl font-bold mb-6">เราคือผู้เชี่ยวชาญด้านเมล็ดพันธุ์คุณภาพ</h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              โกรเวอร์แพลนท์เป็นผู้นำในการวิจัย พัฒนา และจำหน่ายเมล็ดพันธุ์คุณภาพสูงสำหรับแตงโม พริก และเมล่อน 
        ...
        <div className="container max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center mb-20">
            ...
            <div className={`w-full lg:w-1/2 transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-20'}`}>
              ...
              <p className="text-lg text-muted-foreground mb-8">
                ...
                เราจึงสามารถผลิตเมล็ดพันธุ์ที่มีความแข็งแรง ทนทานต่อโรคและศัตรูพืช 
                และให้ผลผลิตสูง
              </p>
          ...
          <div className="text-center mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <div className="p-6">
                <h3 className="text-2xl font-semibold mb-4 text-trima-600">คุณภาพ</h3>
                <p className="text-muted-foreground">เราใส่ใจในทุกขั้นตอนการผลิตเพื่อให้ได้เมล็ดพันธุ์คุณภาพสูงสุด</p>
              </div>
              <div className="p-6">
                <h3 className="text-2xl font-semibold mb-4 text-trima-600">นวัตกรรม</h3>
                <p className="text-muted-foreground">เรานำเทคโนโลยีใหม่ๆ มาพัฒนาพันธุ์พืชให้ดีขึ้นอย่างต่อเนื่อง</p>
              </div>
              <div className="p-6">
                <h3 className="text-2xl font-semibold mb-4 text-trima-600">ความไว้วางใจ</h3>
                <p className="text-muted-foreground">เราสร้างความมั่นใจให้เกษตรกรด้วยผลิตภัณฑ์และบริการที่เชื่อถือได้</p>
              </div>
            </div>
          </div>
        </div>
